...
export class TransactionTest {
  ...
  static async testTransactionSigning() {
    ...
    try {
      ...
      const signerVerified =
        firstSignature &&
        'publicKey' in firstSignature &&
        firstSignature.publicKey.equals(sender.publicKey);
  ...
  static async testVersionedTransaction() {
    ...
    try {
      ...
      const versionedTransaction = await transactionService.createVersionedTransferTransaction(
        transferParams
      );
